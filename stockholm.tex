...
\tinyexpbox{The goal of the project was to realize a signal injector, able to ``simulate'' the behaviour of the physical sensor. An array of DACs at its core, the deliverable consisted in a small box, controlled via REST api, able to physically interface to the amplifier board. My role in the project:
\begin{itemize}
