...
\expbox{CTT is a touch screen technology startup, providing cost effective and minimal overhead ways to add pressure sensing capabilities to touchscreen technologies. At CTT I design and manage the realization of several projects and tools to diagnose, test and benchmark components of the hardware stack. On top of that, I was tasked with the rearchitecturing and realization of the company's software assets versioning and CI infrastructure.}
