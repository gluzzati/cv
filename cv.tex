...
5G Innovation Centre, Guildford, UK\\
...
\tiny Thesis topics: resource allocation, communication networks, signal processing \normalsize\\
...
\cvitem{Senior Research Software Engineer}{Nov 2016 - Current}
\expbox{At the 5GIC I am part of the core network development team, innovating in the field of the next gen 5G communication networks. Along with software design and development, I play an active role in the coordination and management of the team}
...
My role in the team is to design and develop algorithm and software components that expand and integrate the existing framework, as well as creating testing and data visualization tools}
