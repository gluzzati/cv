...
\cvitem{DSP and Software Team Leader}{Jan 2022 - currently}
\cvitem{Principal DSP Engineer}{Jul 2021 - Dec 2021}
\cvitem{Senior DSP Engineer}{Oct 2018 - Jun 2021}
\expbox{CTT is a touch sensing technology startup, providing cost effective ways to add touch-pressure sensing capabilities to display and non-display surfaces. 
...
Over the years I've set up the company's software development and deployment workflow, as well as the testing/CI automation infrastructure.}
