...
\expbox{I am a software engineer with a strong scientific background. I love designing, dissecting, understanding and improving systems. 
...
I started my journey at CTT working at the low level implementation of the company's algorithms and intellectual property (IP). My role rapidly expanded to include full-stack responsibilities, ensuring integration of development and operational workflows.
...
My current responsibilities include defining strategies and managing the operations of the DSP team, ensuring development threads can progress harmoniously to meet objectives and deadlines.
...
\begin{itemize}
 ...
 \item Built an internal microservice ecosystem that defines and automates the full lifecycle of our algorithm libraries, from code development to chip provisioning. Technologies include Python FastAPI, Artifactory, MySQL, Docker
 \item Built data pipelines to streamline and scale the analysis and exploration of large datasets
\end{itemize}
