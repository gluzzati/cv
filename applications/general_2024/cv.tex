...
\expbox{
% I am a software engineer with a strong scientific background. I love designing, dissecting, understanding and improving systems. 
% I strive to be pragmatic and holistic in my decisions, and have a track record of delivering solid and (re)usable solutions.
My biggest drive is to build things and tools. 
Throughout the years I've been hands on working with and around software, to build and improve systems that extract information from noisy and complex data. 
What I bring to the table is an extensive experience in designing and implementing solutions to clean, refine, classify signals and data, with particular focus on practical aspects such as measuring and ensuring the quality of such systems, organizing development and automating procedures that cover the whole lifecycle, from testing through build, to deployment.
}
\vspace{0.5em}
\moveleft\hoffset\vbox{\color{color1}\hrule width\resumewidth height 1pt}\smallskip % Horizontal line after name; adjust line thickness by changing the '1pt'
% \vspace{0.5em}
...
I started my journey at CTT working at the embedded implementation of the company's algorithms and intellectual property (IP). My role rapidly expanded to include full-stack responsibilities, ensuring integration of development and operational workflows.
I gradually pivoted towards a technical lead role, where alongside ensuring development of the core libraries, I've been working cross-disciplinarily and cross-teams to advance the technology into new experimental applications.

As a team leader, my responsibilities today also include translating the company's strategy into goals for my team members, finding and removing obstacles from their roadmaps, and ensuring effective transfer of knowledge to/from other teams.
My philosophy is to focus the team coordination on the big picture and key expectations, so that team members can have the largest possible decisional autonomy.
...
\begin{itemize}
 ...
 \item Built data / ETL pipelines to streamline and scale the analysis and exploration of large datasets
\end{itemize}
