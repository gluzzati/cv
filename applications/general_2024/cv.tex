...
Currently, my responsibilities include translating the company's strategy into goals for my team members, finding and removing obstacles from their roadmaps, and ensuring effective transfer of knowledge among other teams and mine. 
My philosophy is to focus the team coordination on the big picture and key expectations, so that team members can have the largest possible decisional autonomy for their level.
