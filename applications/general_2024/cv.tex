...
What I bring to the table is a broad, full-stack approach that extends beyond just algorithmic performance, to encompass the complete SDLC: quality assurance, automated build processes, testing, and deployment.
