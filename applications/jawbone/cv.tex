...
\expbox{CTT is a touch screen technology startup, providing cost effective and minimal overhead ways to add pressure sensing capabilities to touchscreen technologies. At CTT I'm in charge of designing and realizing several projects and tools to diagnose, test and benchmark components of the hardware and software stack. Given my experience in software engineering, I was also tasked with the rearchitecturing of the company's software versioning and CI infrastructure.}
