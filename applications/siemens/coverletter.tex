...
After starting my carreer in the academic research, I felt that I needed to strenghten my technical skills and get hands on experience, to achieve a solid and well rounded skill set. I've been working for the last years in a few tech-oriented small start-up companies, where I was able to get transversal exposure to a great deal of problems and aspects.

I currently work in a touchscreen technology company, developing and researching tools to diagnose and test different components of our technology stack. I've also been tasked with taking charge of the software repositories, and have become the go-to person for what concerns automating tests, architecting software integration processes and coordinating the collaborative contribution to the codebase.

I was recently thinking of moving back to Italy, and I found this job post for test architect in Genoa to be incredibly interesting and fitting my experience and inclinations.

I hope you'll find my profile relevant, and really look forward to get the chance to enter the selection process.
