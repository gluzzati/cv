...
\end{itemize}
The prototype as a proof of concept was validated against known 
samples, and successfully flagged manually undetected defects. A second, 
more powerful iteration is now in design.
}
